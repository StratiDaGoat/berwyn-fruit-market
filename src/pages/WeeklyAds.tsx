...
export const WeeklyAds: React.FC = () => {
  ...
  const handlePrint = () => {
    // Open the Week 50 PDF file for printing
    const printWindow = window.open('/weekly-ad-50.pdf', '_blank');
    if (printWindow) {
      printWindow.onload = () => {
        setTimeout(() => {
          printWindow.print();
  ...
  const handleDownload = () => {
    // Download the Week 50 PDF file
    try {
      const link = document.createElement('a');
      link.href = '/weekly-ad-50.pdf';
      link.download = 'weekly-specials-week50.pdf';
      link.target = '_blank';
      ...
      window.open('/weekly-ad-50.pdf', '_blank');
    }
  };
