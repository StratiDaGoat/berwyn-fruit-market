...
export const WeeklyAds: React.FC = () => {
  ...
  const handlePrint = () => {
    // Open the Week 6 PDF file for printing
    const printWindow = window.open('/weekly-ad-week-6.pdf', '_blank');
    if (printWindow) {
      printWindow.onload = () => {
        setTimeout(() => {
          printWindow.print();
  ...
  const handleDownload = () => {
    // Download the Week 6 PDF file
    try {
      const link = document.createElement('a');
      link.href = '/weekly-ad-week-6.pdf';
      link.download = 'weekly-specials-week6.pdf';
      link.target = '_blank';
      ...
      window.open('/weekly-ad-week-6.pdf', '_blank');
    }
  };
